...
const initialCartItems = [
    {
        ...
        category: "HOROLOGY",
        title: "Elysian Chronograph",
        details: "Lunar Silver / 40mm",
        quantity: 1,
        price: 240.00,
        unitPrice: 240.00
    },
    {
        ...
        category: "AUDIO",
        title: "Atelier Sound V2",
        details: "Obsidian Indigo / Noise Cancelling",
        quantity: 1,
        price: 395.00,
        unitPrice: 395.00
    },
    {
        id: 3,
        image: "https://images.unsplash.com/photo-1602928321679-560bb4611599?w=800&auto=format&fit=crop&q=60",
        category: "LIFESTYLE",
        title: "Twilight Fig Candle",
        details: "300g / Soy Wax Blend",
        quantity: 2,
        price: 130.00,
        unitPrice: 65.00
    }
...
const CartPage = () => {
    ...
    const handleUpdateQuantity = (id, newQuantity) => {
        ...
        setCartItems(prev => prev.map(item =>
            item.id === id ? { ...item, quantity: newQuantity, price: item.unitPrice * newQuantity } : item
        ));
    };
            ...
            <section className="bg-muted/10 py-16 px-4 md:px-8 border-t border-border/50">
                <div className="container mx-auto max-w-7xl">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        {homeProducts.slice(1, 5).map((product) => (
