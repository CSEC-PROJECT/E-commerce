...
const HeroSection = () => (
  <section className="relative overflow-hidden bg-[#3b2dd3] min-h-[600px] flex items-center">
    ...
    <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center py-12">
      <div className="lg:col-span-7">
        ...
        <button
          type="button"
          className="bg-white text-indigo-600 font-bold text-xs uppercase tracking-[0.2em] px-10 py-4 rounded-md shadow-xl hover:bg-zinc-100 transition-all active:scale-95"
        >
          Explore Products
        </button>
      </div>
...
const OurStorySection = () => (
  <section className="max-w-7xl mx-auto px-6 lg:px-12 py-24 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
    <div className="order-2 lg:order-1 aspect-video lg:aspect-square rounded-2xl overflow-hidden shadow-lg bg-zinc-200">
      <img
    ...
    <div className="order-1 lg:order-2">
      <span className="text-[11px] font-black uppercase tracking-[0.3em] text-indigo-600 block mb-4">
        The Digital Atelier
      </span>
...
const StatsSection = () => (
  <section className="bg-blue-100 border-y border-zinc-200,"> 
    <div className="max-w-7xl mx-auto px-6 lg:px-12 py-12 grid grid-cols-2 lg:grid-cols-4 gap-8">
      {STATS_DATA.map((stat) => (
        <div key={stat.label} className="text-center group">
          <p className="text-3xl lg:text-4xl font-black tracking-tighter text-indigo-600 transition-transform group-hover:scale-110">
            {stat.value}
          </p>
...
const WhySection = () => (
  <section className="max-w-7xl mx-auto px-6 lg:px-12 py-24 bg-blue-50 rounded-2xl">
    <div className="flex flex-col items-center text-center mb-16">
      <h2 className="text-3xl font-black tracking-tight text-zinc-900">
        Why E-Shop?
      </h2>
      <div className="mt-3 h-1 w-10 rounded-full bg-indigo-600" />
    </div>
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
      {FEATURES_DATA.map((feature) => (
        <div
          key={feature.title}
          className="p-8 rounded-2xl border border-zinc-200 bg-white hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
        >
          <div className="w-12 h-12 rounded-xl bg-indigo-50 flex items-center justify-center mb-6">
            

            <div 
              className="w-6 h-6 bg-indigo-600"
              style={{
          ...
          <h3 className="font-black text-zinc-900 text-sm mb-3 uppercase tracking-wide">
            {feature.title}
          </h3>
...
const CTASection = () => (
  <section className="px-6 lg:px-12 pb-20">
    <div className="bg-[#3b2dd3] py-20 px-8 rounded-[2.5rem] shadow-2xl relative overflow-hidden text-center mt-16">
      <div className="max-w-2xl mx-auto relative z-10">
        ...
        <button
          type="button"
          className="bg-white text-indigo-700 font-bold text-xs uppercase tracking-widest px-12 py-4 rounded-lg shadow-lg hover:scale-105 transition-transform"
        >
          Start Shopping
        </button>
      </div>
...
const AboutPage = () => {
  return (
    <main className="min-h-screen text-zinc-900 font-sans bg-zinc-50 selection:bg-indigo-100">
      <HeroSection />
      <OurStorySection />
      <StatsSection />
      <WhySection />
