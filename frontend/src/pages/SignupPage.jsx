...
export default function SignupPage() {
  const { setIsPeeking } = useOutletContext();
  ...
  return (
    <div className="w-full space-y-8">
      <div className="text-center lg:text-left animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
        <h1 className="text-4xl font-black tracking-tight text-foreground">Create Account</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-6 mt-8 animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
        ...
        <button
          type="submit"
          className="inline-flex w-full items-center justify-center rounded-md text-sm font-bold bg-primary text-primary-foreground hover:opacity-90 h-11 px-8 py-2 transition-all active:scale-[0.98]"
        >
          Create Account
