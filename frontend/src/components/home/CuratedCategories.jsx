      ...
      <div className="container mx-auto max-w-7xl">
        <div className="flex flex-col md:flex-row justify-between items-end mb-12">
          <div>
            ...
            <p className="text-muted-foreground text-base md:text-lg font-medium">Structured by design, built for life.</p>
          </div>
          <Link to="/products" className="text-primary hover:opacity-80 font-bold text-lg flex items-center gap-2 mt-4 md:mt-0 transition-colors">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {categories.map((category) => (
            <Link to="/products" key={category.id} className="group relative h-[450px] rounded-[2rem] overflow-hidden cursor-pointer shadow-sm hover:shadow-xl transition-all duration-300 block">
