...
const ChangePassword = ({ onClose }) => {
    ...
    return (
        <div className="bg-card w-full max-w-md rounded-2xl p-6 md:p-10 shadow-2xl relative overflow-hidden">
            ...
            <div className="space-y-6">
                ...
                <div className="pt-4 flex flex-col md:flex-row gap-4">
                    <button
                        onClick={onClose}
                        className="hidden md:flex flex-1 h-14 bg-muted text-foreground rounded-xl font-bold items-center justify-center hover:bg-surface-soft transition-all"
                    >
                        Cancel
                    </button>
                    <button
                        ...
                        className="flex-[2] h-14 bg-primary text-white rounded-xl font-black flex items-center justify-center gap-3 hover:opacity-90 hover:scale-[1.02] active:scale-95 transition-all shadow-lg shadow-primary/20 uppercase tracking-widest text-xs"
                    >
                        Save Changes
                        <ArrowRight size={18} />
                    </button>
